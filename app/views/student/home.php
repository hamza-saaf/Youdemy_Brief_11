...
$ComplexData = $TeacherController->getPage($rowsPerPage, $offset, $_SESSION['user']['role_id']);
...
<body class="bg-gray-50">
    ...
    <header class="fixed top-0 left-0 right-0 bg-white shadow-sm z-50 ">
        <nav class="container mx-auto px-6 py-4 max-sm:py-2">
            <div class="flex items-center justify-between">
                ...
                <?php else: ?>
                    <div class="flex items-center space-x-4">
                        <a
                            class="px-6 py-2.5 text-blue-600 hover:text-blue-700 font-medium  max-sm:px-2  max-sm:py-1 max-sm:text-sm"><?php echo $_SESSION['user']['name']; ?></a>
                        <a href="../logout.php">
                            <div
                        ...
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <div class="grid grid-cols-2 gap-3 text-sm">
                                    ...
                                    <?php if ($course['isIncripted']): ?>
                                        <div class="flex items-center text-white justify-end">
                                            <a href="home.php?coursID=<?= $course['id'] ?>"
                                                class="px-3 py-1 bg-red-600 rounded-md">Applayed</a>
                                        </div>
                                    <?php else: ?>
                                        <div class="flex items-center text-white justify-end">
                                            <a href="home.php?coursID=<?= $course['id'] ?>"
    ...
    <nav class=" flex w-full justify-center">
        <ul class="inline-flex h-10 ">
            <li>
                <a href="home.php?page=<?= max(1, $currentPage - 1); ?>"
            ...
            <li>
                <a href="home.php?page=<?= min($totalPages, $currentPage + 1); ?>"
